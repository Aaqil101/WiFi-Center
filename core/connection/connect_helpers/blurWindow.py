...
dwm: ctypes.WinDLL = ctypes.windll.dwmapi
...
def HEXtoRGBAint(HEX: str) -> int:
    ...
    green: str = HEX[3:5]
    red: str = HEX[1:3]
    gradientColor: str = alpha + blue + green + red
    return int(gradientColor, base=16)


def set_accent_policy(hwnd, accent_state, gradient_color=0, accent_flags=0) -> None:
...
def set_window_corner_preference(hwnd, preference, border_color) -> None:

...
Because of white flashing issue in dark mode I have included the code from the original project here and made some changes to it.
"""
...
def ApplyMica(
    HWND: int, Theme: bool = MicaTheme.DARK, Style: bool = MicaStyle.DEFAULT
) -> int:
    ...
    try:
        ...
        threading.Thread(
            target=__apply_theme, daemon=True, name="Win32mica helper"
        ).start()
